        ...
        <div>
            <Paper style={{
                ...
                <Grid container direction="column" alignContent="center" alignItems="center" spacing={1}>
                    ...
                    <Grid xs={12} item>
                        <TextField id="confirm-email" label="Confirm Email" value={confirmedEmail} onChange={onTextFieldUpdate(setConfirmedEmail)} helperText={!areSame(confirmedEmail, email) ? 'Emails do not match' : ''} error={!areSame(confirmedEmail, email)}></TextField>
                    </Grid>
                    <Grid xs={12} item>
                    ...
                    <Grid xs={12} item >
                        <TextField id="confirm-password" label="Confirm Password" value={confirmedPassword} onChange={onTextFieldUpdate(setConfirmedPassword)} helperText={!areSame(confirmedPassword, password) ? 'Passwords do not match' : ''} error={!areSame(confirmedPassword, password)} type="password"></TextField>
                    </Grid>
                    <Grid xs={12} item>
